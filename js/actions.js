...
function timeline() {
	...
	//Reset width between years
		eventsMinDistance = 99;
	...
	*/
	...
	function checkMQ() {
		...
		return window.getComputedStyle(document.querySelector('.timeline'), '::before').getPropertyValue('content').replace(/'/g, "").replace(/"/g, "");
	}
}
